        ...
        <div className="flex flex-col grow mt-32">
            <div className="flex flex-row">
                <div className=" bg-slate-900 mb-6">
                    ...
                    <svg className="p-1 w-[35px] h-[35px] text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
