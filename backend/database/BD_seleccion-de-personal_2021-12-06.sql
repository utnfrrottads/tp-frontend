...
CREATE TABLE `ciudades` (
  ...
  CONSTRAINT `fk_ciudades_provincias` FOREIGN KEY (`provincias_id_provincia`) REFERENCES `provincias` (`id_provincia`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `contactos` (
  ...
  `tipoContacto` enum('email','telefono','web') DEFAULT NULL,
  `valor` varchar(128) DEFAULT NULL,
  `personas_id_persona` int DEFAULT NULL,
  `empresas_id_empresa` int DEFAULT NULL,
  `experiencias_id_experiencia` int DEFAULT NULL,
  `descripcion` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id_contacto`),
  KEY `fk_contactos_personas1_idx` (`personas_id_persona`),
  KEY `fk_contactos_empresas1_idx` (`empresas_id_empresa`),
  KEY `fk_contactos_experiencias1_idx` (`experiencias_id_experiencia`),
...
INSERT INTO `direcciones` VALUES (58,1961,'2630','San Lorenzo',1111,NULL,NULL),(60,1961,'2630','Moreno',2222,'B',4),(75,2003,'2503','Salta',3333,'F',20),(102,200,'3131','Jujuy',4444,NULL,NULL),(103,201,'3232','Catamarca',5555,'A',1);
...
CREATE TABLE `entrevistas` (
  ...
  `descripcion` varchar(63) CHARACTER SET utf8 NOT NULL,
  `fecha_hora` datetime NOT NULL,
  `estado` enum('pendiente','finalizada','cancelada','reprogramada') CHARACTER SET utf8 NOT NULL,
  `comentario` varchar(1023) CHARACTER SET utf8 DEFAULT NULL,
  `personas_id_candidato` int NOT NULL,
  `personas_id_evaluador` int NOT NULL,
  `vacantes_id_vacante` int NOT NULL,
  PRIMARY KEY (`id_entrevista`),
  KEY `fk_entrevistas_personas1_idx` (`personas_id_candidato`),
  KEY `fk_entrevistas_vacantes1_idx` (`vacantes_id_vacante`),
  KEY `fk_entrevistas_personas_idx` (`personas_id_evaluador`),
...
INSERT INTO `evaluaciones` VALUES (1,'Evaluacion tecnica de desarrollo backend'),(3,'Evaluacion tecnica de desarrollo frontend'),(6,'Evaluacion psicofisica'),(7,'Test psicologico'),(8,'Test de aptitud');
...
CREATE TABLE `experiencias` (
  ...
  `competencias` text,
  `tipo_experiencia` enum('academica','laboral') NOT NULL,
...
INSERT INTO `paises` VALUES (1,'Argentina'),(2,'Bolivia'),(3,'Brasil'),(4,'Chile'),(5,'Colombia'),(6,'Ecuador'),(7,'Mexico'),(8,'Paraguay'),(9,'Peru'),(10,'Uruguay'),(11,'Venezuela');
...
CREATE TABLE `personas` (
  ...
  `tipo_persona` enum('candidato','evaluador') NOT NULL,
...
INSERT INTO `personas` VALUES (53,'Raul','Rodriguez','1990-12-21','masculino','11111111','evaluador',58),(55,'Jose','Memo','1965-08-25','masculino','22222222','evaluador',60),(65,'Marta','Sanchez','1963-12-05','femenino','33333333','candidato',75),(92,'Francisca','Lopez','1995-04-14','femenino','44444444','candidato',102),(93,'Ricardo','Quito','1980-01-01','masculino','55555555','candidato',103);
...
CREATE TABLE `provincias` (
  ...
  CONSTRAINT `fk_provincias_paises` FOREIGN KEY (`paises_id_pais`) REFERENCES `paises` (`id_pais`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `resultados` (
  `entrevistas_id_entrevista` int NOT NULL,
  `evaluaciones_id_evaluacion` int NOT NULL,
  `resultado_evaluacion` varchar(64) DEFAULT NULL,
  `comentario` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`entrevistas_id_entrevista`,`evaluaciones_id_evaluacion`),
  KEY `fk_entrevistas_has_evaluaciones_evaluaciones1_idx` (`evaluaciones_id_evaluacion`),
  KEY `fk_entrevistas_has_evaluaciones_entrevistas1_idx` (`entrevistas_id_entrevista`),
  CONSTRAINT `fk_entrevistas_has_evaluaciones_entrevistas1` FOREIGN KEY (`entrevistas_id_entrevista`) REFERENCES `entrevistas` (`id_entrevista`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_entrevistas_has_evaluaciones_evaluaciones1` FOREIGN KEY (`evaluaciones_id_evaluacion`) REFERENCES `evaluaciones` (`id_evaluacion`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
